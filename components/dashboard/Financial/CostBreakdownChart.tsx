    ...
    >
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-xl font-bold text-white">
              Répartition des Coûts par Technologie
            </h3>
            <p className="text-sm text-gray-400 mt-1">
              Détail des coûts provider par composant technique
            </p>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-800/50">
          <h4 className="text-sm font-semibold text-white mb-3">Détail par Technologie</h4>
