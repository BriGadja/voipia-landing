-- Migration: Fix KPI logic and calculations (Version 2 - Safe)
...
--
-- Safety: Drops existing functions before recreating them to avoid conflicts

-- ==============================================================================
-- STEP 1: DROP EXISTING FUNCTIONS (if they exist)
-- ==============================================================================

-- Drop get_kpi_metrics if it exists (all possible signatures)
DROP FUNCTION IF EXISTS get_kpi_metrics(DATE, DATE, UUID, UUID);
DROP FUNCTION IF EXISTS get_kpi_metrics(DATE, DATE, UUID);
DROP FUNCTION IF EXISTS get_kpi_metrics(DATE, DATE);

-- Drop get_chart_data if it exists (all possible signatures)
DROP FUNCTION IF EXISTS get_chart_data(DATE, DATE, UUID, UUID);
DROP FUNCTION IF EXISTS get_chart_data(DATE, DATE, UUID);
DROP FUNCTION IF EXISTS get_chart_data(DATE, DATE);


-- ==============================================================================
-- STEP 2: UPDATE VIEW v_agent_calls_enriched
-- ==============================================================================
...
-- ==============================================================================
-- STEP 3: CREATE FUNCTION get_kpi_metrics
-- ==============================================================================
...
-- ==============================================================================
-- STEP 4: CREATE FUNCTION get_chart_data
-- ==============================================================================
